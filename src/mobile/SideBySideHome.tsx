...
const SideBySideHome : FunctionComponent<SideBySideHomeProps> = ({header, image, splashBackground, noLink, responsiveImage}) => {
    ...
    return (
    <div className="SideBySide--container" style={splashBackground ? {maxHeight: '80vh', color: 'white !important', background: 'linear-gradient(5deg, rgba(15,95,95,1) 0%, rgba(9,39,57,1) 50%)'} : {}}>
        {
            noLink ? 
            <div />
            :
        ...
        <ScrollAnimation animateIn="animate__fadeInRight" animateOnce offset={0}>
        {
            responsiveImage ?
            <MockupPhone 
            style={{zoom: 0.35, marginLeft: '10vw'}}
            content={
                <img
