...
const NavBar = (props: {isRelative?: boolean, isTransparent?: boolean}) => {
    return (
        <div style={{backgroundColor: props.isTransparent ? 'transparent' : '#092739', position: props.isRelative ? 'relative' : 'absolute', display: 'flex', alignItems: 'center'}} className="nav-bar">
