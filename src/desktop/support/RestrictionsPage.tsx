        ...
        <div className="restrictions">
            ...
            <div className="restrictions__content">
                <div className="restrictions__column">
                    <Row emoji="🕹️" text="Location Restrictions"/>
                ...
                <div className="restrictions__column">
                    <Row emoji="🕹️" text="Age Restrictions" />
                    Users have to be 18 to play. To verify this, Lukrio asks you to confirm your date of birth during registration.
                    <Row emoji="🕹️" text="Fraud Restrictions" />
...
const Row : FunctionComponent<RowProps>= ({emoji, text}) => {
    return (
        <div className="restrictions__row">
