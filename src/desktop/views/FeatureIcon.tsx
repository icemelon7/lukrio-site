...
const FeatureIconDisplay : FunctionComponent<FeatureIconDisplayProps> = ({hideLink}) => {
    ...
    <div className="Desktop--FeatureIconDisplay--wrapper">
        {
            !hideLink ? 
            <ScrollAnimation animateIn="animate__fadeIn" animateOnce delay={1000}><Redirect text="Learn more about us" url="lukrio" textColor={LightMode.darkWhite}/></ScrollAnimation>
            :
            <div/>
        }
        <FeatureIconBlock
